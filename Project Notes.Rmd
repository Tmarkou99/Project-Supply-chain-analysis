...
3)  Subset3 contains a customer demographic part of the original data set. 3.1) The output that we get using this data set is firstly the demog_type1 which shows the destribution of the buyers
